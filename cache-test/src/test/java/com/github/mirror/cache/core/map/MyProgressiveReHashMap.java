package com.github.mirror.cache.core.map;
...
public class MyProgressiveReHashMap<K,V> extends AbstractMap<K,V> implements Map<K,V> {
    ...
    private static final SimpleLogger log = LogUtil.getLogger(MyProgressiveReHashMap.class);
