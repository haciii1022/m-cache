...
import com.github.mirror.cache.core.support.struct.lru.impl.LruMapCircleList;
...
public class CacheEvictClock<K,V> extends AbstractCacheEvict<K,V> {
    ...
    private static final SimpleLogger log = LogUtil.getLogger(CacheEvictClock.class);
