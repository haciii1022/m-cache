package com.github.mirror.cache.core.support.struct.lru.impl;
...
import com.github.mirror.cache.core.model.DoubleListNode;
...
public class LruMapDoubleList<K,V> implements ILruMap<K,V> {
    ...
    private static final SimpleLogger log = LogUtil.getLogger(LruMapDoubleList.class);
